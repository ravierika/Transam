...
class TransactionHotelController extends Controller
{
    ...
    public function index()
    {
        ...
        //return $users;
        return view('transactions.hotels.index', compact('users', 'compn', 'name', 'role', 'facebook', 'twitter', 'insta', 'linkedin'));
    ...
    public function create()
    {
        ...
        $linkedin=Auth::user()->linkedin;
        $cityn = Location::all();
        return view('transactions.hotels.create', compact('compn', 'name', 'role', 'facebook', 'twitter', 'insta', 'linkedin'));
