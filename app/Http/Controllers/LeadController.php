...
class LeadController extends Controller
{
    ...
    public function index()
    {
        ...
        //return $users;
        return view('lead.flights.index', compact('users', 'compn', 'name', 'role', 'facebook', 'twitter', 'insta', 'linkedin'));
    }
    ...
    public function create()
    {
        ...
        $linkedin=Auth::user()->linkedin;
        $cityn = Location::all();
        return view('lead.flights.create', compact('compn', 'name', 'role', 'facebook', 'twitter', 'insta', 'linkedin'));
