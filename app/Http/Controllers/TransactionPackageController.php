...
class TransactionPackageController extends Controller
{
    ...
    public function index()
    {
        ...
        //return $users;
        return view('transactions.packages.index', compact('users', 'compn', 'name', 'role', 'facebook', 'twitter', 'insta', 'linkedin'));
    ...
    public function create()
    {
        ...
        $linkedin=Auth::user()->linkedin;
        $cityn = Location::all();
        return view('transactions.packages.create', compact('compn', 'name', 'role', 'facebook', 'twitter', 'insta', 'linkedin'));
